...
Route::group(['prefix' => '/carts/','as' => 'carts.'],function(){
    ...
    //3-returns a json file with all delivered orderes
    ...
    //5-returns a json filw with all info of a specific cart including medicines
    Route::get('{cart}',[CartController::class,'show'])->name('show');
    //6-returns a josn file with the all carts info of the logged in user
    Route::get('user/auth',[CartController::class,'authList'])->name('auth');
    //7-returns cart list for a specefic user
